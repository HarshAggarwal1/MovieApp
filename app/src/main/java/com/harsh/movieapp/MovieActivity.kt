...
class MovieActivity: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mAdViewBanner = movieBinding.adViewBanner
        ...
        val voteAverage: String? = bundle?.getString("voteAverage")
    ...
    private fun applyWindowInsets(mainBinding: ActivityMovieBinding) {
        ViewCompat.setOnApplyWindowInsetsListener(mainBinding.movieLayoutContainer) { v, insets ->
